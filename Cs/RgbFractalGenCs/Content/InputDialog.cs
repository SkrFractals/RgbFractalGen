...
public partial class InputDialog : Form {
	...
	public InputDialog() {
		...
		SetupControl(textBox, Tag == null ? "" : (string)Tag);
	...
	#region Events
	private void CancelButton_Click(object s, EventArgs e) => Finish(DialogResult.Cancel);
	private void PasteButton_Click(object s, EventArgs e) => textBox.Text = Clipboard.GetText();
	private void OkButton_Click(object s, EventArgs e) => Finish(DialogResult.OK);
	private void TextBox_TextChanged(object s, EventArgs e)
