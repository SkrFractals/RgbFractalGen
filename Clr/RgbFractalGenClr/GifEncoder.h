...
public:
     ...
     * @return
     */
    bool push(System::Threading::CancellationToken token, PixelFormat format, const uint8_t *frame, int width, int height, int delay);
     ...
     * @return
     */
    bool close(System::Threading::CancellationToken token);
