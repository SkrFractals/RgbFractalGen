...
public:
     ...
     * @return
     */
    bool push(std::atomic_bool* cancelRequested, PixelFormat format, const uint8_t* frame, int width, int height, int delay);
     ...
     * @return
     */
    bool close(std::atomic_bool* cancelRequested);
