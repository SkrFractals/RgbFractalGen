...
#pragma region Windows Form Designer generated code
	void GeneratorForm::InitializeComponent(void) {
		...
		this->parallelTypeBox->Location = System::Drawing::Point(149, 649);
		this->parallelTypeBox->Name = L"parallelTypeBox";
		this->parallelTypeBox->Size = System::Drawing::Size(147, 23);
...
#pragma region Core
	...
	System::Void GeneratorForm::timer_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		const auto b = generator->GetBitmapsFinished();
		...
		if (b > 0) {
			...
			Bitmap^ bitmap = bitmaps[currentBitmapIndex];
